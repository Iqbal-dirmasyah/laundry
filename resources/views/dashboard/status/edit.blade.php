...
<form action="/status-dashboard/{{ $statuses->id}}" method="post">
@method('PUT')
@csrf
   ...
   <div class="mb-2">
    ...
    <input type="text" class="form-control @error('status') is-invalid @enderror" name="status" id="status" value="{{ old('status',$statuses->status) }}">
    </div>
