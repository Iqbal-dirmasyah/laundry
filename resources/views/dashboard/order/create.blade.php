...
<form action="/order-dashboard" method="post">
@csrf
    <div class="mb-2">
    ...
    <input type="text" class="form-control @error('barang') is-invalid @enderror" name="barang" id="barang" >
    </div>
    <div class="mb-2">
    ...
    <input type="text" class="form-control @error('no_order') is-invalid @enderror" name="no_order" id="no_order" >
    </div>
